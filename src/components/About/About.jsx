      ...
      <div className="aboutParts">
        ...
        <div className="part2">
          <p className="detailsPart">
            An organization built in 2012 to help for building skills,guiding
            students to start in the right way for their career
          </p>
          ...
          >
            ...
            <div className="AboutDescription">
              ...
              <p className="cardAbout_description">
                {" "}
                Choose your course suits your career and start learning any time
                you like
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="AboutDescription">
              ...
              <p className="cardAbout_description">
                gain your Certification and earn more offer choosing by you
                ,start your own project with experts or start new course for
                free
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="AboutDescription">
              ...
              <p className="cardAbout_description">
                Take advantage of gaining experience from great experts that
                will support you during your project
              </p>
            </div>
          </div>
        </div>
